...
class StockEnvTrade(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            #plt.savefig(self.PATH_RESULTS+'/account_value_trade_{}_{}.png'.format(self.model_name, self.iteration))
            #plt.close()

            df_total_value = pd.DataFrame(self.asset_memory)
            df_total_value.to_csv(self.PATH_RESULTS+'/account_value_trade_{}_{}.csv'.format(self.model_name, self.iteration))
            
            df_dates = pd.DataFrame(self.date_memory)
            df_dates.to_csv(self.PATH_RESULTS+'/account_date_trade_{}_{}.csv'.format(self.model_name, self.iteration))
            ...
            df_rewards.to_csv(self.PATH_RESULTS+'/account_rewards_trade_{}_{}.csv'.format(self.model_name, self.iteration))
            ...
            self.date_memory.append(self.day_str)
